 ...
 */
public class AcceptedDonationStudent extends Fragment {
    ...
    public AcceptedDonationStudent() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View acceptedStudent = inflater.inflate(R.layout.fragment_accepted_donation_student, container, false);

        mcontext = getActivity();
        total_count = acceptedStudent.findViewById(R.id.all_count);
        listView = acceptedStudent.findViewById(R.id.list_view_pending_all);
    ...
    public void getPendingDonations() {
        ...
        sendData.getStudentAccepted(LoginFragment.userid);
    }
