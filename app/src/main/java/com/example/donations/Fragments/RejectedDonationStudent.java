 ...
 */
public class RejectedDonationStudent extends Fragment {
    ...
    public RejectedDonationStudent() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rejectedStudent = inflater.inflate(R.layout.fragment_accepted_donation_student, container, false);

        mcontext = getActivity();
        total_count = rejectedStudent.findViewById(R.id.all_count);
        listView = rejectedStudent.findViewById(R.id.list_view_pending_all);
    ...
    public void getPendingDonations() {
        ...
        sendData.getStudentRejected(LoginFragment.userid);
    }
